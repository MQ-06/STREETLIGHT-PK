"""
Model Loader Utility (standalone copy for inference_service deploy).
"""
import logging
import os
...
class ModelLoader:
    ...
    def _download_from_hub(self):
        try:
            ...
            raise ImportError("huggingface_hub is required.") from e

        repo_id = os.getenv("HF_REPO_ID")
        if not repo_id:
            raise EnvironmentError("HF_REPO_ID env var not set")
